    ...
    <div className='w-full min-h-screen flex items-center justify-center p-4'>
      <div className='w-full md:w-3/4 flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start gap-4 shadow-sm rounded-lg overflow-hidden p-1'>
        <div className='flex-1'>
          <div className='p-2 border border-black/10 rounded-lg overflow-hidden shadow-sm relative'>
            <p className='absolute right-4 top-4'>{product.isAvailable ? <span className='text-white p-1 px-3 rounded-lg bg-green-500'>Available</span> : <span className='text-white p-1 px-3 rounded-lg bg-red-500'>Unavailable</span>}</p>
