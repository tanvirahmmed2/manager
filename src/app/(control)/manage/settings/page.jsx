    ...
    <div className='w-full p-4 flex flex-col items-center justify-center gap-8'>
      ...
      <form onSubmit={changeTitle} className='w-full flex flex-col gap-2'>
        ...
        <div className='w-full flex flex-row items-center justify-between gap-4'>
          ...
          <button type='submit' className='px-4 p-1 bg-sky-400 text-center rounded-lg hover:scale-[1.02] transform ease-in-out duration-500 cursor-pointer text-white'><MdOutlineSystemUpdateAlt/></button>
        </div>
      </form>
